...
Alarm::Alarm() { name = "null"; }
Alarm::Alarm(String name, DaysOfWeek dow, uint8_t hour, uint8_t minute, MusicStream stream,
...
bool Alarm::isEnabled() { return enabled; }
String Alarm::getName() const { return name; }
DaysOfWeek& Alarm::getDow() { return dow; }
uint8_t Alarm::getHour() const { return hour; }
uint8_t Alarm::getMinute() const { return minute; }

float Alarm::getVolume() const { return volume; }

MusicStream& Alarm::getStream() { return stream; }
}